    ...
    <>
      <div className='visor visor_4'>
        <div className='contPreguntas'>
          <h1 className='pregunta'>Pregunta4: Lorem ipsum, dolor sit amet consectetur adipisicing. nosekee?</h1>
          <ul className='grid'>
            <div>
      ...
      <div className='carta'>
        <h1 className='preguntaCard'>Pregunta4: Lorem ipsum, dolor sit amet consectetur adipisicing. nosekee?</h1>

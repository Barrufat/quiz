    ...
    <>
      <div className='visor visor_5'>
        <div className='contPreguntas'>
          <h1 className='pregunta'>Pregunta5: Lorem ipsum, dolor sit amet consectetur adipisicing. nosekee?</h1>
          <ul className='grid'>
            <div>
      ...
      <div className='carta'>
        <h1 className='preguntaCard'>Pregunta5: Lorem ipsum, dolor sit amet consectetur adipisicing. nosekee?</h1>

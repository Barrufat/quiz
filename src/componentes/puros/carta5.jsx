...
const Carta5 = ({ siguienteSend, sendPuntos, sendPausa, segundo, gameOver }) => {
  ...
  return (
    <>
      <div className='visor visor_5'>
        <div className='contPreguntas'>
          <h1 className='pregunta'>Is cryopreservation a plant conservation process?</h1>
          <div>
            <h2 className={color3} >Yes</h2>
            <h2 className={color3B}>Yes</h2>
          </div>
          <div>
            <h2 className={color1} >No</h2>
            <h2 className={color1B} >No</h2>
          </div>
        </div>
      </div>
      <div className='carta'>
        <h1 className='preguntaCard'>Is cryopreservation a plant conservation process?</h1>
        <div>
          <h2 className={color3Card} onClick={PreguntaAcertada}>Yes</h2>
          <h2 className={color3BCard}>Yes</h2>
        </div>
        <div>
          <h2 className={color1Card} onClick={Pregunta1}>No</h2>
          <h2 className={color1BCard} >No</h2>
        </div>

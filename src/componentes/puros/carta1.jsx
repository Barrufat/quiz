...
const Carta1 = ({ siguienteSend, segundo, gameOver }) => {
  ...
  useEffect(() => {
    primera ? setColor1('respuestaIncorrecta') : setColor3('respuesta');
  ...
  return (
    <div className='carta'>
      <h1 className='pregunta'>Pregunta1: Leleleleleleleleelle?</h1>
      <h2 className={color1} onClick={Pregunta1}>Respuesta 1</h2>
      <h2 className={color2} onClick={Pregunta2}>Respuesta 2</h2>
      <h2 className={color3} onClick={PreguntaAcertada}>Respuesta 3</h2>
